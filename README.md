...
* **Python**
* **TensorFlow / Keras** (Building and training the models)
* **NumPy** (Array manipulations)
* **Matplotlib** (Data visualization and plotting results)

`![Prediction Grid](./images/predictions.png)`
`![Training Accuracy](./images/accuracy_graph.png)`

## 🤝 Credits
All core concepts and instructional guidance are from the [visuara YouTube channel](https://www.youtube.com/playlist?list=PLPTV0NXA_ZSgmWYoSpY_2EJzPJjkke4Az).
